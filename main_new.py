...
temp = [word_bag[7:-8] for word_bag in text if "<title>" in word_bag][38:]
...
for query in temp:
    ...
    with open(root + "\\search_res_coocc\\" + "query" + str(index), 'wb') as f: #<--- change the directory name accordingly
        pickle.dump(dic, f)
